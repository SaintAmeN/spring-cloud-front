package com.amen.services.ui.auth;

import com.amen.services.ui.component.TokenParserUtility;
import com.amen.services.ui.config.UserJwtConfig;
import com.amen.services.ui.model.exception.security.UnauthorizedCall;
import com.amen.services.ui.model.exception.security.UnauthorizedIpCall;
import com.amen.services.ui.model.AuthenticationInfo;
        ...
        try {
            ...
            if (username != null) {
                ...
                UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(
                        new AuthenticationInfo(String.valueOf(claims.get(userJwtConfig.getLoginClaimTag())),
