...
var Gradient = function(api, options) {
  ...
  $.extend(that, {
    ...
    bind() {
      ...
      //   if (data.stop) {
      //     that.active(data.stop.lenderId);
    ...
    markers: {
      ...
      active(id) {
        ...
        that.$markers.focus();
        // that.api._trigger('apply', that.value.getById(lenderId).color);
      },
      mousedown(marker, e) {
        const self = this;
        /* eslint consistent-this: "off" */
...
class AsColorPicker {
  ...
  open() {
    ...
    $$1("#asColorPicker-dropdown").removeAttr("lenderId");
    this.$dropdown.attr("lenderId", "asColorPicker-dropdown");
